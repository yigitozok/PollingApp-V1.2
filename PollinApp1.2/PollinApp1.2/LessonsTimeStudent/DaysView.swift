...
struct DaysView : View{
    ...
    @State var days : [Day] = [Day(dayName: "Monday", isActive: false),Day(dayName: "Tuesday", isActive: false),Day(dayName: "Wednesday", isActive: false),Day(dayName: "Thursday", isActive: false),Day(dayName: "Friday", isActive: false)]
                            ...
                            ForEach($days){$item in
                                ...
                                if item.isActive && item.dayName == dayName1{
                                    ...
                                    ForEach(0..<lessonTime1.count,id: \.self){indeks in
                                        ...
                                        withAnimation{
                                            DaysDetailView(receiveTeacherName: selectedTeacherName, reveiceLessonDayTimes:lessonTime1[indeks], receiveLessonName: receiveCourse,receiveWeek: receiveWeek,receiveDepartmant: receiveDepartmant)
                                    ...
                                    ForEach(0..<lessonTime2.count,id: \.self){indeks in
                                        withAnimation{
                                            DaysDetailView(receiveTeacherName: selectedTeacherName, reveiceLessonDayTimes:lessonTime2[indeks], receiveLessonName: receiveCourse,receiveWeek:receiveWeek,receiveDepartmant:receiveDepartmant)
                                                .transition(.asymmetric(insertion: .scale, removal: .opacity))
                                        }
                                    }
                                }
