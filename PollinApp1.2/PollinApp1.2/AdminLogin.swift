...
struct AdminLogin: View {
                ...
                VStack{
                    HStack{
                        VStack(alignment: .leading,spacing: 5){
                            ...
                            Text("Enter Your Username & Passoword")
                    ...
                    VStack(spacing: 15){
                        ...
                        .navigationDestination(isPresented: $isPresentedNewAccount){
                                AdminCourses(lessonList: $listLesson, selectedUserName: $userName,selectedDepartmant: $selectedDepartmant)
                        }
                        NavigationLink{
                            NewAccount()
                        }label: {
    ...
    //Check the admin has been registered before.
    func isEnter() -> Bool{
        for item in user.users{
            print(item)
