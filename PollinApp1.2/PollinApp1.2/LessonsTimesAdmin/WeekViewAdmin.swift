                ...
                ForEach(weeks,id: \.self) { week in
                    ZStack{
                        ...
                        VStack(alignment: .leading){
                            HStack{
                                NavigationLink(destination: DaysViewAdmin(receiveDepartmant:selectedDepartmant,receiveCourse: selectedCourses,receiveWeek: week),
                                        label: {
                                            Text(week)
...
struct WeekViewAdmin_Previews: PreviewProvider {
